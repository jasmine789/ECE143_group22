...
def racial_disparity_states_killedOverPopulation(fileName, outputName = 'racial_disparity_states_killed1m', statesList = ['California', 'New York', 'Texas']):
    """
...
if __name__ == '__main__':
    ...
    racial_disparity_states_killedOverPopulation(fileName)